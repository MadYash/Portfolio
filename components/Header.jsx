...
export default function Header() {
  ...
  return (
    <>
      {/* Page Container */}
      <div id="page-container" className="flex flex-col mx-auto w-full  min-w-[320px] bg-gray-100 dark:text-gray-100 dark:bg-gray-900">
        {/* Page Header */}
            ...
            <div className="flex justify-between py-4">
              ...
              <div className="flex items-center space-x-2 lg:space-x-5">
                ...
                <nav className="hidden lg:flex items-center space-x-2">
                  ...
                  {/* <Link href="/about" className="group text-sm font-medium flex items-center space-x-2 px-3 py-2 rounded-lg text-gray-800 border border-transparent hover:text-blue-600 hover:bg-blue-50 active:border-blue-100 dark:text-gray-200 dark:hover:text-white dark:hover:bg-gray-700 dark:active:border-gray-600">
